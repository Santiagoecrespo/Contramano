  ...
  return (
    <Layout>
      <section className="hero">
        ...
        <aside className="prompt-card" aria-label="Ejemplo de consigna">
      ...
      <section className="how-it-works" aria-labelledby="how-title">
        ...
        <div className="steps">
          <article><b>01</b><h3>Creá la mesa</h3><p>Elegí el tono y compartí QR o link.</p></article>
          <article><b>02</b><h3>Tomá postura</h3><p>Te toca defenderla aunque no sea la tuya.</p></article>
          <article><b>03</b><h3>Voten y sigan</h3><p>La mesa decide. Cinco rondas y revancha.</p></article>
        </div>
      </section>
    </Layout>
  )
