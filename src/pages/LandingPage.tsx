...
import { selectLandingPreviews } from '../lib/landingPreviews'
...
export function LandingPage() {
  const [previews] = useState(() => selectLandingPreviews())
    ...
    <Layout>
      <div className="landing-page">
        <section className="hero">
          ...
          {preview && <aside className="prompt-card hero-debate-card" aria-label="Ejemplo decorativo de consigna">
            <div className="prompt-topline"><span className="tag tag-blue">MODO BARDO</span><span>01:00</span></div>
