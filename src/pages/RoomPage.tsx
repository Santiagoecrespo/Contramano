...
export function RoomPage() {
  ...
  const debateRemaining = room.phase === 'paused' ? room.pausedRemainingSeconds ?? 0 : timeLeft(currentRound?.debateEndsAt ?? null, serverNow)
  const votingRemaining = room.phase === 'paused' ? room.pausedRemainingSeconds ?? 0 : timeLeft(currentRound?.voteEndsAt ?? null, serverNow)
