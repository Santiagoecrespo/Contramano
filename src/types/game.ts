...
export type MockRoom = { code: string; hostId: string; intensity: Intensity; phase: GamePhase; players: MockPlayer[]; rounds: MockRound[]; decks: Record<Intensity, MockDeck>; lastOddExtraSide: Side | null; createdAt: string; expiresAt: string }
